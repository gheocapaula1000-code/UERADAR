-- FIX: ueradar_start_trial impostava trial_source='app_no_card', valore non
-- ammesso dal CHECK constraint: ogni attivazione falliva in rollback.
-- L'assenza di carta resta una proprietà del flusso applicativo, non un valore DB.
