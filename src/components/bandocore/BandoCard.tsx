...
import { Calendar, MapPin, Zap, Euro, ArrowRight, Sparkles } from "lucide-react";
...
export function BandoCard({ bando }: { bando: Bando }) {
  ...
  return (
    <div className="group rounded-2xl border border-border bg-card p-5 shadow-elevated transition hover:border-primary/50 flex flex-col">
