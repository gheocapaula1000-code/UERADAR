...
const inputCls =
  "w-full min-h-11 rounded-lg border border-border bg-input px-3 py-2.5 text-base sm:text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-ring";
