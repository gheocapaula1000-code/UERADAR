  ...
  return (
    <LegalPage title="Termini di servizio">
      ...
      <LegalSection title="Piani e prezzi">
        ...
        <p>Il numero di opportunità pertinenti mostrate non è mai limitato. Le fonti ufficiali consultate sono le stesse per tutti i piani self-service. I piani si distinguono per frequenza degli aggiornamenti programmati, capienza di utenti operativi e dossier inclusi: 1 dossier al mese con PROFESSIONAL, 5 con BUSINESS, 15 con EXECUTIVE. Gli utenti operativi indicati comprendono il titolare dell'impresa.</p><p>Una opportunità è indicata come Verificata soltanto quando sono disponibili fonte ufficiale raggiungibile, data e versione del documento, stato della misura, scadenza, beneficiari ammessi, territorio, intensità del contributo, spese ammissibili e documenti richiesti. Il dossier prepara e precompila i dati per la revisione dell'utente: non viene inviato automaticamente agli enti e non sostituisce il professionista incaricato. I tempi di notifica indicati si misurano dal momento del rilevamento da parte di UEradar.</p>
