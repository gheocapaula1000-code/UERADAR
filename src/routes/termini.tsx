  ...
  return (
    <LegalPage title="Termini di servizio">
      ...
      <LegalSection title="Prova gratuita e attivazione">
        <p>La prova gratuita dura 7 giorni, non richiede carta di credito né dati bancari e non prevede alcun addebito automatico al termine. È una prova applicativa: non viene creata alcuna sottoscrizione presso il provider di pagamento e non è richiesto alcun metodo di pagamento per iniziare. Scade automaticamente, senza conversione e senza addebito. Offre temporaneamente il livello Business con una impresa, un utente, due obiettivi, cinque verifiche approfondite e una anteprima dossier filigranata. È ammessa una prova per Partita IVA e per dominio aziendale ogni 12 mesi. Il servizio a pagamento parte soltanto con attivazione volontaria dell'utente e conferma esplicita del prezzo mostrato.</p>
      </LegalSection>
      <LegalSection title="Piani e prezzi">
        <p>I piani self-service sono tre, tutti riferiti a una sola impresa verificata e con prezzi IVA esclusa: PROFESSIONAL a €499 al mese oppure €4.990 all'anno con 2 utenti operativi; BUSINESS a €990 al mese oppure €9.900 all'anno con 5 utenti operativi; EXECUTIVE a €1.990 al mese oppure €19.900 all'anno con 10 utenti operativi. La formula annuale include due mensilità. Il piano ENTERPRISE parte da €3.990 al mese + IVA, non prevede acquisto online e si definisce su preventivo: più imprese, fonti dedicate, API e webhook, workflow e limiti stabiliti da contratto. Gli utenti indicati sono capienza tecnica del piano e non la leva di valore del servizio.</p>
        <p>Il numero di opportunità pertinenti mostrate non è mai limitato. I piani si distinguono per frequenza delle ricerche, ampiezza delle fonti ufficiali, verifiche approfondite e dossier inclusi: PROFESSIONAL esegue la ricerca completa due volte al giorno su fonti regionali, nazionali e principali programmi dell'Unione Europea, con 25 verifiche approfondite e 1 dossier al mese; BUSINESS esegue la ricerca completa ogni due ore con corsia urgente ogni 15 minuti, include anche fonti locali, camerali, di agenzie, settoriali e di nicchia, con 100 verifiche e 5 dossier al mese; EXECUTIVE esegue la ricerca completa ogni ora con corsia urgente ogni 5 minuti, aggiunge verifica incrociata e monitoraggio delle modifiche, con 300 verifiche e 15 dossier al mese.</p><p>Una opportunità è indicata come Verificata soltanto quando sono disponibili fonte ufficiale raggiungibile, data e versione del documento, stato della misura, scadenza, beneficiari ammessi, territorio, intensità del contributo, spese ammissibili e documenti richiesti. Il dossier prepara e precompila i dati per la revisione dell'utente: non viene inviato automaticamente agli enti e non sostituisce il professionista incaricato. I tempi di notifica indicati si misurano dal momento del rilevamento da parte di UEradar.</p>
