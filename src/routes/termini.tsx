  ...
  return (
    <LegalPage title="Termini di servizio">
      ...
      <LegalSection title="Piani e prezzi">
        <p>L'unico piano acquistabile online è Istruttoria, riferito a 1 Impresa · 5 Utenti (stessa PWA, stesso account), a €449 al mese oppure €4.490 all'anno, IVA non applicabile (regime forfettario). La formula annuale include due mensilità. Il piano STUDIO parte da €990 al mese, non prevede acquisto online e si definisce su richiesta: più imprese, integrazioni, workflow e limiti stabiliti da contratto. Gli utenti indicati sono capienza tecnica del piano e non la leva di valore del servizio.</p>
      ...
      <LegalSection title="Stato della fatturazione">
        <p>I pagamenti avvengono online in modalità live tramite il provider autorizzato Stripe. I prezzi indicati sono definitivi. La prova gratuita di 7 giorni non richiede carta di credito né dati bancari e non prevede alcun addebito automatico. L’abbonamento a pagamento Istruttoria si attiva solo con conferma esplicita dell’utente al checkout. La cancellazione avviene online dal pannello account, senza disdetta scritta e senza PEC, con effetto dal periodo successivo.</p>
      </LegalSection>
