  ...
  return (
    <LegalPage title="Termini di servizio">
      ...
      <LegalSection title="Prova gratuita e attivazione">
        <p>La prova gratuita dura 7 giorni, non richiede carta di credito né dati bancari e non prevede alcun addebito automatico al termine. È una prova applicativa: non viene creata alcuna sottoscrizione presso il provider di pagamento e non è richiesto alcun metodo di pagamento per iniziare. Scade automaticamente, senza conversione e senza addebito. Il perimetro della prova è: una impresa, un titolare, un massimo di due obiettivi e un dossier in versione filigranata. È ammessa una prova per Partita IVA e per dominio aziendale ogni 12 mesi. Il servizio a pagamento parte soltanto con attivazione volontaria dell'utente e conferma esplicita del prezzo mostrato.</p>
      </LegalSection>
