  ...
  return (
    <LegalPage title="Informativa privacy">
      ...
      <LegalSection title="Prova, attivazione e pagamenti">
        <p>La prova gratuita dura 7 giorni, non richiede carta di credito né dati bancari né disdetta, non crea alcuna sottoscrizione presso il provider di pagamento e non genera addebiti automatici. Il servizio a pagamento parte solo con attivazione volontaria; l'unico piano acquistabile online è ISTRUTTORIA a €449 al mese oppure €4.490 all'anno, sempre + IVA, con formula annuale che include due mensilità; il piano STUDIO parte da €990 al mese + IVA su richiesta. La cancellazione avviene online, senza disdetta scritta e senza PEC. In questa fase la fatturazione elettronica è tecnicamente disattivata fino al collaudo: non trattiamo dati di pagamento e non è collegato alcun circuito di incasso.</p>
      </LegalSection>
