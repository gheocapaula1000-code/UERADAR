  ...
  return (
    <LegalPage title="Informativa privacy">
      ...
      <LegalSection title="Prova, attivazione e pagamenti">
        <p>La prova gratuita dura 7 giorni, non richiede carta di credito né dati bancari, non crea alcuna sottoscrizione presso il provider di pagamento e non genera addebiti automatici. Il servizio a pagamento parte solo con attivazione volontaria; i piani self-service sono PROFESSIONAL a €499 al mese, BUSINESS a €990 al mese ed EXECUTIVE a €1.990 al mese, sempre + IVA, con formula annuale che include due mensilità; il piano ENTERPRISE parte da €3.990 al mese + IVA su preventivo. La cancellazione avviene online, senza disdetta scritta e senza PEC. In questa fase la fatturazione elettronica è tecnicamente disattivata fino al collaudo: non trattiamo dati di pagamento e non è collegato alcun circuito di incasso.</p>
      </LegalSection>
